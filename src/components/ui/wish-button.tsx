export default function WishButton() {
	return (
		<button className={'relative flex h-auto shrink-0 items-center justify-center focus:outline-none'} aria-label={'cart-button'}>
			<svg xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 23.947 20.316'} className={'h-auto w-5'}>
			...
			<span className={'cart-counter-badge absolute -top-2.5 -right-3 flex items-center justify-center rounded-full bg-heading font-bold text-white -end-2.5 xl:-top-3 xl:-end-3'}>0</span>
		</button>
	)
}
