...
const CategoryListCardLoader = (props: any) => (
	<ContentLoader speed={2} width={389} height={88} viewBox={'0 0 389 88'} backgroundColor={'#f9f9f9'} foregroundColor={'#ecebeb'} className={'w-full rounded-md bg-gray-200'} {...props}>
